object DarkFamilies {
    ...
    val nielsenFamily = partnership(
            FamilyMember("The", "Unknown"),
            FamilyMember("Agnes", "Nielsen", 1910)
    ) {
    ...
    val dopplerFamily = partnership(
            FamilyMember("Bernd", "Doppler", 1913),
            FamilyMember("Greta", "Doppler", 1917)
    ) {
    ...
    val kahnwaldFamily = partnership(
            FamilyMember("Daniel", "Kahnwald", 1915),
            Unidentified
    ) {
        child("Ines", "Kahnwald", 1940)
    }

    val obendorfFamily = partnership(
            FamilyMember("Jürgen", "Obendorf", 1971),
            Unidentified
    ) {
